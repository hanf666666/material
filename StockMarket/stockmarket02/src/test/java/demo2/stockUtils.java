...
public class stockUtils {
     ...
     * @return
     */
    public static HashMap<String, Stock>  stockper(String code,String starttime,String endtime){
        HashMap<String, Stock>  historyPerStockMap=null;
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                //System.out.println("该股票的历史数据"+line);
                // System.out.println("历史数据==="+line.substring(22,line.length()-2));
                endtime=simpleDateFormat2.format(date);
                historyPerStockMap=  historyPerStock(line.substring(22,line.length()-2),endtime);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        return historyPerStockMap;
    }

    //算是否可以入股
    private static HashMap<String, Stock>  historyPerStock(String  json,String currentdate) {

        JSONObject jsonObject = null;
        HashMap<String, Stock> stringStockHashMap = new HashMap<String, Stock> ();
        try {
            ...
            for (int i = 0; i < hq.length(); i++) {
               ...
               /*  * 返回的数据以这条为例"2018-07-20","61.22","61.83","0.61","1.00%","61.22","62.69","57637","35856.55","0.53%";
                ...
                // System.out.println("股票对象：======="+stock);
                stringStockHashMap.put(stockcode+","+curdatetime,stock);
        ...
        System.out.println("一只股票的历史数据为一个map,stringStockHashMap==="+stringStockHashMap);
        return stringStockHashMap;
    }
